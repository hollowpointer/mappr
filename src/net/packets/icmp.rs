...
use pnet::packet::icmpv6::{Icmpv6Code, Icmpv6Packet, Icmpv6Type, checksum};
use pnet::packet::{Packet, icmpv6};
...
pub fn create_all_nodes_echo_request_v6(
    ...
    let mut icmp = icmpv6::echo_request::MutableEchoRequestPacket::new(
        &mut pkt[icmp_payload_start..icmp_payload_end],
    )

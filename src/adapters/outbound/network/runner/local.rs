...
use crate::{
    domain::models::host::{Host, InternalHost},
    adapters::outbound::network::{
        datalink::{channel::{self, EthernetHandle}, ethernet}, ip,
        protocol::{self, dns},
        sender::SenderConfig, transport::{self, UdpHandle},
    },
...
impl LocalRunner {
    ...
    pub fn get_hosts(self) -> Vec<InternalHost> {
